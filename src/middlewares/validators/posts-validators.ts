...
const validatePostDescription = body("shortDescription").trim().isString().isLength({min: 0, max: 100});
const validatePostContent = body("content").isString().isLength({min: 0, max: 1000});
